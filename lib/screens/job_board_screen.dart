...
class _JobBoardScreenState extends State<JobBoardScreen> {
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text(job['title'] ?? '',
                  style: GoogleFonts.outfit(fontSize: 17, fontWeight: FontWeight.bold, color: const Color(0xFF2D3142))),
          ...
          Row(children: [
            ...
            Text('Deadline: ${job['deadline'] ?? ''}',
                style: GoogleFonts.inter(fontSize: 13, color: Colors.red[400], fontWeight: FontWeight.w600)),
          ]),
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text('Apply Now', style: GoogleFonts.inter(fontWeight: FontWeight.w600)),
            ),
          ),
        ]),
      ),
  ...
  Widget _buildEmpty() => Center(child: Padding(
    ...
    child: Column(children: [
      ...
      Text('No job circulars available', style: GoogleFonts.outfit(color: Colors.grey[400], fontSize: 16)),
      const SizedBox(height: 8),
      Text('Pull down to refresh', style: GoogleFonts.inter(color: Colors.grey[300], fontSize: 13)),
    ]),
  ));
}
