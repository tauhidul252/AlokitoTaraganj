        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Donate Blood', style: GoogleFonts.outfit(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                  Text('Your blood can save a life.', style: GoogleFonts.inter(color: Colors.white.withValues(alpha: 0.9))),
                ])),
              ]),
            ),
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return GestureDetector(
                    onTap: () { setState(() => _selectedGroup = g); _load(); },
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: selected ? [BoxShadow(color: Colors.red.withOpacity(0.3), blurRadius: 8)] : [],
                      ),
            ...
            if (_loading)
              ...
              ..._grouped.entries.map((entry) => _buildGroupSection(entry.key, entry.value)),
          ],
        ),
      ),
    );
      ...
      Padding(
        ...
        child: Row(children: [
          Container(
            ...
            child: Text(group, style: GoogleFonts.outfit(fontWeight: FontWeight.bold, color: Colors.red, fontSize: 16)),
          ),
          const SizedBox(width: 10),
          Text('Donors', style: GoogleFonts.outfit(fontSize: 18, fontWeight: FontWeight.w600, color: Colors.black87)),
        ]),
      ),
      ...donors.map((donor) => Container(
        ...
        child: ListTile(
          ...
          leading: CircleAvatar(backgroundColor: Colors.red.shade50, child: Icon(Icons.person, color: Colors.red.shade400)),
          title: Text(donor['name'] ?? '', style: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 16)),
          subtitle: Text(donor['location'] ?? '', style: GoogleFonts.inter(color: Colors.grey[500], fontSize: 13)),
          trailing: donor['phone'] != null && donor['phone'].toString().isNotEmpty
              ? IconButton(
                  icon: const CircleAvatar(backgroundColor: Colors.green, radius: 18, child: Icon(Icons.call, color: Colors.white, size: 18)),
  ...
  Widget _buildEmpty(String msg, IconData icon) {
    return Center(child: Padding(
      ...
      child: Column(children: [
        ...
        const SizedBox(height: 16),
        Text(msg, style: GoogleFonts.outfit(color: Colors.grey[400], fontSize: 16)),
      ]),
    ));
  }
}
